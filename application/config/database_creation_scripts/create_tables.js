...
connnection.connect(function (err) {
    ...
    var sql = "CREATE TABLE mods (id VARCHAR(36) PRIMARY KEY, username VARCHAR(255), password VARCHAR(255), status INT);" +
        ...
        "CREATE TABLE posts (pid VARCHAR(36) PRIMARY KEY, title VARCHAR(255), author NVARCHAR(255), jtitle NVARCHAR(255), description VARCHAR(255), details NVARCHAR(500), type NVARCHAR(255), cover VARCHAR(255), image VARCHAR(255), status INT, date DATETIME, origin VARCHAR(255), approvedby VARCHAR(255));" +
